...
# @app.route("/index.html/?<path:code>")
# def filters(code):
#     # Configure API request
#     url = "https://developer.nps.gov/api/v1/parks?stateCode={}&api_key={}".format(code, os.environ.get("NPS_KEY"))
#     print(os.environ.get("NPS_KEY"))
#     response = urllib.request.urlopen(url)
#     data = response.read()
#     dict = json.loads(data)
...
# @app.route("/generic.html/", defaults={"code":""})
